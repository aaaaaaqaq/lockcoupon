/**
 * lib/temuOffers.ts — shared Temu affiliate code pool + static offer copy.
 * Used by:
 *   • app/api/cron/temu-codes (legacy daily rotation, kept for manual runs)
 *   • app/api/cron/daily-refresh (scheduled rotation with AI-fresh copy;
 *     falls back to OFFER_TEMPLATES when generation fails)
 */
